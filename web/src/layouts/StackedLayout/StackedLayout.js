            ...
            <div className="flex">
              ...
              <div className="hidden sm:ml-6 sm:flex">
                <NavLink
                  ...
                  className="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-orange-700 transition duration-150 ease-in-out"
                >
                  News
                </NavLink>
                <NavLink
